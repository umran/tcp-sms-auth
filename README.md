...
// client calls back with a response - the arguments are the IP (http) object received from the server and the challenge code received via sms (as a hex string)
